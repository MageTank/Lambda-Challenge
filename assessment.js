  ...
  */
  ...
  function longestString(strs) {
    ...
    for (var counter = 0; counter < strs.length; counter++){
      ...
      if(strs[counter].length > longestlength)
      {
      longestlength = strs[counter].length;
      longestString = strs[counter];
      }
  }
  ...
  */
  ...
  var average = 0;
   for(var counter = 0; counter < users.length; counter++)
      totalAges = totalAges + users[counter].age;
    
    
    
    average = totalAges/users.length;
